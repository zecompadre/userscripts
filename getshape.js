(function () {
	...
	window.addEventListener('load', function () {
		...
		button.onclick = function (e) {
			...
			msg.innerHTML = "SHAPE " + titleCase(text) + ", copiada para o clipboard<br />Verificar -> <a id='shapetest' href='https://wkt-plotter.zecompadre.com/' target='_shapetest'> Shape Test!</a>";
